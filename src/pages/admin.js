            ...
            {[...examples].map((item => {
                return (
                    <Grid item xs={12} lg={6} >
                        <Box>
                            <Typography variant="h3" component="h5">{item.title}</Typography>
                        ...
                        <Box marginTop="10px">
                            <iframe title={item.title} height={item.height}
                                    src={item.url}
                                    sandbox="allow-scripts allow-same-origin" width="100%"
                                    style={{border: "0px"}}/>
                        </Box>
                    </Grid>
                )
                ...
                <Box paddingY="50px">
                    <Container maxWidth="xl">
                        <Box textAlign="center">
                            ...
                            <Box marginTop="10px">
                                <Typography variant="h5" component="h5">
                                    使用最前沿的技术栈和最新的框架版本，保证项目的安全和开发高效率。                                </Typography>
                            </Box>
